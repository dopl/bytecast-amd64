...
public class ModRmParserImplTest {
    ...
    public void comprehensiveTest() throws EOFException {
        ...
        // Test   4004b4:	66 66 66 2e 0f 1f 84 	nopw   %0x0(%rax,%rax,1)
        ...
        input.skip(2);
        instance.parse(context, input, IModRmParser.RegType.REG64, IModRmParser.RmType.REG_MEM64);
        assertTrue(new OperandTypeMemoryEffectiveAddress(RegisterType.RAX, RegisterType.RAX, 1, 0).equals(instance.getRmOperand().getOperandValue()));
