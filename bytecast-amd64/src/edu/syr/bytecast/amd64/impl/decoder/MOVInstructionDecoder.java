...
import edu.syr.bytecast.amd64.impl.parser.ModRmParserImpl;
...
public class MOVInstructionDecoder implements IInstructionDecoder {
    ...
    @Override
    public IInstruction decode(edu.syr.bytecast.amd64.impl.instruction.IInstructionContext context, edu.syr.bytecast.amd64.impl.parser.IInstructionByteInputStream input) throws EOFException {
        byte b = input.read();
        ...
        if (b == (byte) 0x88) {
            ...
            if (context.getOperandSize() == InstructionContextImpl.OperandOrAddressSize.SIZE_16) {
                ...
                // Opcode:      89 /r
                ret.setOpCode("89");
                IModRmParser rm_parser = new ModRmParserImpl();
